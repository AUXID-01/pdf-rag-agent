...
def debug_intent(query, doc_id):
    ...
    for intent in sub_intents:
        ...
        print(f"  Lexical Match (ALL): {lexical_match} (Words: {words})")
...
debug_intent("repo rate and crypto", "RBI-Monetary-Policy-October-2023.pdf")
debug_intent("AI regulation", "RBI-Monetary-Policy-October-2023.pdf")
